...
import { ArticleData } from '../article/__mocks__';
...
describe('Article Model Test', () => {
  ...
  context('when image is not a valid url ', () => {
    ...
    it('it does not creates an article', async () => {
      try {
  ...
  context('when likes is a negative no', () => {
  ...
  context('when dislikes is a negative no', () => {
    const badlikes = { ...ArticleData };
